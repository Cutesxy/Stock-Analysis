...
一个本地运行的个人投资决策工具:**月线滚动通道**定位买卖点、**历史锚点回测**量化胜率、**本地数据库**管理持仓。前后端分离(FastAPI + 原生ES模块),行情软件式界面——浅色主题、蜡烛图+成交量、报价条、图例条、中式红涨绿跌;手机浏览器打开可"添加到主屏幕"当独立APP用。
...
**四个页面**(桌面顶部导航/手机底部Tab):
- **概览**——三标的报价条(sparkline+σ位置)+ 一句话建议横幅 + 大图表(520px高:**分时/日K切换**——分时=价格线+均价线+昨收基准+量柱,日K=蜡烛+成交量+通道带+作战位1年/2年,点击报价卡换标的) + 操作面板(作战位距离+一键记账)
